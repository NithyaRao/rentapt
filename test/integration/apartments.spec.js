...
describe('apartments', () => {
  ...
  // describe('get /apartments/vacant', () => {
  //   it('should get all vacant apartments', (done) => {
  //     request(app)
  //       .get('/apartments/vacant?filter[renter]=none')
  //     .end((err, rsp) => {
  //       console.log('Vacant *******', rsp.body, err);
  //       expect(err).to.be.null;
  //       expect(rsp.status).to.equal(200);
  //       expect(rsp.body.apartments).to.have.length(3);
  //       done();
  ...
  // });
  //
  // describe('get /apartments/occupied', () => {
  //   it('should get all occupied apartments', (done) => {
  //     request(app)
  //       .get('/apartments/occupied?filter[renter]=none')
  //     .end((err, rsp) => {
  //       console.log('Occupied *******', rsp.body, err);
  //       expect(err).to.be.null;
  //       expect(rsp.status).to.equal(200);
  //       expect(rsp.body.apartments).to.have.length(0);
  //       done();
